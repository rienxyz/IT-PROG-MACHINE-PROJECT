...
<body>
    ...
    <ul>
        <li>Create / verify accounts (doctors, secretaries)</li>
        <li>Assign roles: patient, secretary, doctor, receptionist</li>
        <li>Define & adjust structural roles</li>
    </ul>
    ...
    <p>Secure export · backup · chronological activity logs</p>
